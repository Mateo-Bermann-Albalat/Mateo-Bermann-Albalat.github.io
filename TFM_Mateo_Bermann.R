...
png("arbol regresion.png", width = 800, height = 600, res = 120)
rpart.plot(arbol_regresion, type = 1, extra = 101, tweak = 1.2, box.palette = "auto")
dev.off()
...
png("arbol decision2.png", width = 1000, height = 600, res = 120)
rpart.plot(arbol_decision2, type = 1, extra = 101, tweak = 1.2, box.palette = "auto")
dev.off()
